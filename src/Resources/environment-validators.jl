...
function __validate_environment_keys_types_before_build!(
...
function __validate_environment_content!(d::Dict{String,Any}, e::CompositeException)::Bool
    return true
end

# CONSISTENCY VALIDATORS -----------------------------------------------------------------------

function __validate_environment_consistency!(
    d::Dict{String,Any}, e::CompositeException
)::Bool
    return true
end
...
function __build_environment_internals_from_dicts!(
    d::Dict{String,Any}, e::CompositeException
)::Bool
...
function __cast_environment_internals_from_files!(
    d::Dict{String,Any}, e::CompositeException
)::Bool
    valid_key_types = __validate_environment_keys_types_before_build!(d, e)
