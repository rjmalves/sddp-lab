...
| ---------- | ---------------------------------------------- | -------- | ------------------- |
| ticket-041 | Write API reference documentation              | 3 pts    | hpc-julia-developer |
| ticket-042 | Write configuration format reference           | 3 pts    | sddp-specialist     |
| ticket-043 | Create tutorial examples for advanced features | 4 pts    | sddp-specialist     |

## Dependencies

- Epic 09 must be complete
